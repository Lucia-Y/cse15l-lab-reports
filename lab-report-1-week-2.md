...
In order to download the Visual Studio Code application, we need to go the Visual Studio Code website https://code.visualstudio.com/ and follow the dowloading instructions there to download the application to our computers. After we sucessful download the Visual Studio Code application and open it, we can see the image above. 
